...
namespace Template10.Behaviors
{
    ...
    public sealed class ThrottledEventTriggerBehavior : EventTriggerBehaviorBase
    {
        ...
        /// Reset throttle timer after each event.
        /// </summary>
        public static readonly DependencyProperty ResetTimerProperty = DependencyProperty.Register(nameof(ResetTimer), 
                                                                       typeof(bool), 
                                                                       typeof(ThrottledEventTriggerBehavior), 
                                                                       new PropertyMetadata(false, ResetTimerPropertyChangedCallback));
